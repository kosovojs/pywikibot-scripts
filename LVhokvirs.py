...
article = '2020.—2021. gada Optibet hokeja līgas sezona'
...
#
def makeTable():
	url = 'https://www.optibethokejaliga.com/statistika/komandas'
	res = requests.get(url)
...
|source=[https://www.optibethokejaliga.com/statistika/komandas LHF]
