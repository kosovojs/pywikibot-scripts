...
PROP = 'P2494'#'P8286'
URLS = ('https://lv.mantojums', 'http://lv.mantojums')#('http://org.olympedia.www./athletes', 'https://org.olympedia.www./athletes')
...
with open('{}.json'.format(PROP), 'w', encoding='utf-8') as file_w:
