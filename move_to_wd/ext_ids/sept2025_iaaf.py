...
sqlite_conn = sqlite3.connect('ext_ids_iaaf.db')
...
def handle_one_wiki(wiki, cursor, prop, urllist, slow_version):
	...
	WHERE enp.page_namespace = 0 AND enp.page_is_redirect=0 and el_to_domain_index in (
									'http://org.worldathletics.www.',
									'http://org.worldathletics.',
									'https://org.worldathletics.',
									'https://org.worldathletics.www.'
		)
		and el_to_path like '/athletes%';"""
