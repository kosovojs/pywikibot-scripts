...
if len(toreport)>0:
	...
	thetext = 'Šajos labojumos tikušas izņemtas dzēšanas veidne. Lūdzu pārbaudiet!\n{}\n--~~~~'.format('\n'.join([formatted.format(f[0][5],f[0][1].replace('_',' '),f[0][3]) for f in toreport]))
	putNotif(thetext)
