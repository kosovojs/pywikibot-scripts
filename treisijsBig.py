import pywikibot, re, os, collections
...
sqlinputdata = eval(open('treisijs-big-query12121212.txt','r', encoding='utf-8').read())#sql_big_query()
...
def pirma_apstrade():
	...
	salidz = list(set(otro_kartu) - set(cur_items))
	print(len(salidz))
...
def api_wrap(inputdata):
	...
	groupfd=0
	for group in chunker(inputdata,490):
		print(groupfd)
		groupfd += 1
...
Datums: ~~~~~. Dati tiek atjaunināti pēc pieprasījuma.
