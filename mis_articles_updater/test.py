...
SQL_unoptimized = """SELECT ips_item_id, COUNT(ips_item_id), (SELECT GROUP_CONCAT(distinct concat(wb1.ips_site_id, '-frkmarker-',wb1.ips_site_page) separator '|') as 'otherlinks'
...
def sql_big_query():
	...
	try:
		with conn.cursor() as cur:
			...
			filsess1 = open('treisijs-big-query12121212-test-2.txt','w', encoding='utf-8')
